...
class InterfacesControllerTest < ActionController::TestCase
  ...
  test "should create interface" do
    assert_difference('Interface.count') do
      post :create, interface: { api_name: @interface.api_name, api_ref: @interface.api_ref, api_type: @interface.api_type, api_version: @interface.api_version, ymlname: @interface.ymlname }
    end
  ...
  test "should update interface" do
    patch :update, id: @interface, interface: { api_name: @interface.api_name, api_ref: @interface.api_ref, api_type: @interface.api_type, api_version: @interface.api_version, ymlname: @interface.ymlname }
    assert_redirected_to interface_path(assigns(:interface))
  end
